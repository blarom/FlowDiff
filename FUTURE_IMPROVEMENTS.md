...
- Block diagram showing 10-15 architectural components
...
## 🟢 MEDIUM: Improve Diff Comparison Header Design

### Current State
```
Diff: Current flow Latest commit compared with reference flow 1 commit ago
```

Issues:
- Long, dense text line
- Hard to parse visually
- Timestamp information not prominent
- No visual hierarchy
...
<div class="diff-comparison-card">
    <div class="card-header">
        ...
        <span class="title">Diff Comparison</span>
    </div>

    <div class="card-body">
        <div class="flow-section current">
            <div class="flow-badge">🟢 Current Flow</div>
            <div class="flow-description">Latest uncommitted changes</div>
        </div>

        <div class="comparison-divider">
            <span class="icon">⚖️</span>
            <span class="text">compared with</span>
        </div>

        <div class="flow-section reference">
            <div class="flow-badge">🔴 Reference Flow</div>
            <div class="flow-description">Latest commit (HEAD)</div>
        </div>

        <div class="timestamp">
            <span class="icon">📅</span>
            <span class="text">Analyzed 5 minutes ago</span>
        </div>
    </div>
</div>
```
...
**Additional Features**:
- Click to expand full git ref details
- Copy button to copy comparison refs
- Link to view git commit in GitHub/GitLab

### Benefits
- Immediately clear what's being compared
